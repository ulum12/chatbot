                            ...
                            for($j=0;$j<count($k);$j++){
                                if (is_numeric($k[$j])) {
                                    if (isset($pusat_cluster[$x][$j])) {
                                        ...
                                        $hasil = $k[$j]/$total_miu_kuadrat[$j];
                                        $pusat_cluster[$x][$j] = $hasil;
                                        // echo "Pusat Cluster {$x} dan {$j} Miu Kuadrat X ".$k[$j]." / Miu Kuadrat ".$total_miu_kuadrat[$j]." =". $hasil .'<br>';
                                    }
                                }
                            }
                        }
